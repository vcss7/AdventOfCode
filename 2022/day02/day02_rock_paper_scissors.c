 ...
 *
 * Compile: gcc -g -Wall -o day02_rock_paper_scissors.a
 * day02_rock_paper_scissors.c
 *
 * Purpose: Solution to AdventOfCode Problem https://adventofcode.com/2022/day/2
 *
 * Input:   File with A B or C in first column representing opponents shape and
 * X Y or Z in second column representing our shape. Each line is a game.
 *
...
void convert_to_rps (char* shape)
{
    ...
    {
        case 'A':
        case 'X': *shape = 'R'; break;
        case 'B':
        case 'Y': *shape = 'P'; break;
        case 'C':
        case 'Z': *shape = 'S'; break;
    }
}
